...
contract Hedgehog is IERC20 {
    ...
    uint256 totalSupply_ = 5000 ether;
    ...
    function order(address hedgehog, uint256 _amount) external payable onlyWhitelisted {
        ...
        transferFrom(hedgehog, msg.sender, _amount);
    }
